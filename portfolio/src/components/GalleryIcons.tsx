...
export function TwitchOverlaysIcon({ size = 64, className = '' }: IconProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none"
      ...
      {/* Monitor body */}
      <rect x="8" y="10" width="48" height="32" rx="4" stroke={`url(#${cyan})`} strokeWidth="1.8" fill="rgba(0,212,255,0.06)" />
      {/* Screen */}
...
export function PostsIcon({ size = 64, className = '' }: IconProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none"
      ...
      {/* Document */}
      <rect x="10" y="8" width="44" height="52" rx="5" fill="rgba(0,212,255,0.05)" stroke={`url(#${cyan})`} strokeWidth="1.8" />
      {/* Folded corner */}
...
export function StoriesIcon({ size = 64, className = '' }: IconProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none"
      ...
      {/* Phone body */}
      <rect x="16" y="6"  width="32" height="54" rx="7" fill="rgba(0,30,60,0.6)" stroke={`url(#${cyan})`} strokeWidth="1.8" />
      {/* Screen */}
...
export function HackingClubIcon({ size = 64, className = '' }: IconProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none"
      ...
      {/* Window body */}
      <rect x="6" y="10" width="52" height="44" rx="5" fill="rgba(0,10,20,0.8)" stroke={`url(#${green})`} strokeWidth="1.8" />
      {/* Title bar */}
